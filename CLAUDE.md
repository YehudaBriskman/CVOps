...
| `packages/steps` | Python — step implementations loaded by the engine (`extract_frames`, `commit_dataset`, `export_yolo` implemented; `auto_label`, `human_review`, `train` are stubs) | partial |
